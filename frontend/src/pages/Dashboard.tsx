...
const Dashboard: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    // Fetch both countries independently to avoid one failure blocking the other
  ...
  return (
    <div className="dashboard-container">
            ...
            <>
              ...
              <div className="chart-container">
                ...
                <div className="stats">
                  ...
                  <p>
                    Renewable: {calculateRenewablePercentage(nzData.generationMix)}%
                  </p>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div className="chart-container">
                ...
                <div className="stats">
                  ...
                  <p>
                    Renewable: {calculateRenewablePercentage(auData.generationMix)}%
                  </p>
                </div>
              </div>
            </>
      ...
      <footer className="dashboard-footer">
        <p>
          Data sources: NZ - EM6 API | AU - Backend API
        </p>
...
// Helper function to calculate renewable percentage
